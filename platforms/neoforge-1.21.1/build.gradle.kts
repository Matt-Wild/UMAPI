...
extensions.configure<NeoForgeExtension>("neoForge") {
    ...
    runs {
        create("neoForge1211Client") {
            client()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge1211Client"))
        }

        create("neoForge1211Server") {
            server()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge1211Server"))
        }
    }
}
