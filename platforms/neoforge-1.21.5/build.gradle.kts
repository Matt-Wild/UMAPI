...
extensions.configure<NeoForgeExtension>("neoForge") {
    ...
    runs {
        create("neoForge1215Client") {
            client()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge1215Client"))
        }

        create("neoForge1215Server") {
            server()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge1215Server"))
        }
    }
}
