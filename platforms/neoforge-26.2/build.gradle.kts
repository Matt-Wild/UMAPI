...
extensions.configure<NeoForgeExtension>("neoForge") {
    ...
    runs {
        create("neoForge262Client") {
            client()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge262Client"))
        }

        create("neoForge262Server") {
            server()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge262Server"))
        }
    }
}
