...
public final class Fabric1215Platform extends AbstractPlatform {
    public Fabric1215Platform() {
        super(ModLoader.FABRIC, "1.21.5", new FabricLikeEvents(), new Slf4jLogger());
    }
}
