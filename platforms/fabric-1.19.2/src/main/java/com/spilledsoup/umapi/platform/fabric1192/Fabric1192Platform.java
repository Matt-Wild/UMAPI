...
public final class Fabric1192Platform extends AbstractPlatform {
    public Fabric1192Platform() {
        super(ModLoader.FABRIC, "1.19.2", new FabricLikeEvents(), new Slf4jLogger());
    }
}
