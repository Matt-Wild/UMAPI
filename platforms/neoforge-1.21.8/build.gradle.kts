...
extensions.configure<NeoForgeExtension>("neoForge") {
    ...
    runs {
        create("neoForge1218Client") {
            client()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge1218Client"))
        }

        create("neoForge1218Server") {
            server()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge1218Server"))
        }
    }
}
