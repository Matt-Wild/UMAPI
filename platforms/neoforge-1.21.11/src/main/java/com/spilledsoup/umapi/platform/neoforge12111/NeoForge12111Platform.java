...
public final class NeoForge12111Platform extends AbstractPlatform {
    public NeoForge12111Platform() {
        super(ModLoader.NEOFORGE, "1.21.11", new NeoForgeEvents(GameProfileNameNeoForgePlayer::new), new Slf4jLogger());
    }
}
