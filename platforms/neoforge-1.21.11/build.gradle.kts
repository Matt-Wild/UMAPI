...
extensions.configure<NeoForgeExtension>("neoForge") {
    ...
    runs {
        create("neoForge12111Client") {
            client()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge12111Client"))
        }

        create("neoForge12111Server") {
            server()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge12111Server"))
        }
    }
}
