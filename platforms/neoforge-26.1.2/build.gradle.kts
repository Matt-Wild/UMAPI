...
extensions.configure<NeoForgeExtension>("neoForge") {
    ...
    runs {
        create("neoForge2612Client") {
            client()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge2612Client"))
        }

        create("neoForge2612Server") {
            server()
            sourceSet.set(sourceSets.main.get())
            gameDirectory.set(layout.projectDirectory.dir("runs/neoForge2612Server"))
        }
    }
}
